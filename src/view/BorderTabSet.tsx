...
export const BorderTabSet = (props: IBorderTabSetProps) => {
    ...
    let borderClasses =
        cm(CLASSES.FLEXLAYOUT__BORDER) +
        " " +
        cm(CLASSES.FLEXLAYOUT__BORDER_ + border.getLocation().getName());
    ...
    const toolbar = (
        <div
            ...
            ref={toolbarRef}
            className={
                cm(CLASSES.FLEXLAYOUT__BORDER_TOOLBAR) +
                " " +
                cm(
                    CLASSES.FLEXLAYOUT__BORDER_TOOLBAR_ +
                        border.getLocation().getName()
                )
            }
        >
    ...
    return (
        ...
        >
            <div
                ...
                className={
                    cm(CLASSES.FLEXLAYOUT__BORDER_INNER) +
                    " " +
                    cm(
                        CLASSES.FLEXLAYOUT__BORDER_INNER_ +
                            border.getLocation().getName()
                    )
                }
            >
